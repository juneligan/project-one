...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.theProjectOne.first";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "The Project One";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.theProjectOne.first.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.theProjectOne.first.";
