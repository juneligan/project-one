...
* The Project One is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as The Project One is mean to act as a starting point for Android Applications.

# The Project One App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-theprojectone-first.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-theprojectone-first)

This repository contains the source code for the [The Project One](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.theProjectOne.first).

Please see the [issues](https://github.com.theProjectOne.first/com-theprojectone-first/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about The Project One? Ask away on the [com-theprojectone-first discussion forum](https://groups.google.com/forum/#!forum/com-theprojectone-first).

<a href="https://play.google.com/store/apps/details?id=com.theProjectOne.first" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.theProjectOne.first__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.theProjectOne.first__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.theProjectOne.first.R__) will now be renamed
...
signed with a different key.  Manually uninstall The Project One from your device and
...
The Project One is a result of a template project I've developed over the years as well as
...
The Project One is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.theProjectOne.first/com-theprojectone-first/contributors) on
...
[pull requests](https://github.com.theProjectOne.first/com-theprojectone-first/pulls).
