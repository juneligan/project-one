...
package com.theProjectOne.first.test;
...
import static com.theProjectOne.first.core.Constants.Auth.*;

import com.theProjectOne.first.tests.R;
import com.theProjectOne.first.util.Ln;
